...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 20_260_509_000_001,
        name: "batches",
        up_sql: include_str!("../migrations/20260509000001_batches.up.sql"),
        down_sql: include_str!("../migrations/20260509000001_batches.down.sql"),
    },
    Migration {
        version: 20_260_511_000_001,
        name: "schedule_intervals",
    ...
    Migration {
        version: 20_260_701_000_001,
        name: "hot_row_fillfactor",
        up_sql: include_str!("../migrations/20260701000001_hot_row_fillfactor.up.sql"),
        down_sql: include_str!("../migrations/20260701000001_hot_row_fillfactor.down.sql"),
    },
];
